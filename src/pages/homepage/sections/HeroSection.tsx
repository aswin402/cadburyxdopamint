...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#4b0983]">
      ...
      <div className="relative z-10 flex min-h-[min(100svh,52rem)] items-start pt-24 pb-10 sm:pt-28 sm:pb-12 md:min-h-[min(100svh,42rem)] md:pt-32 md:pb-14 lg:min-h-[36rem] lg:pt-40 lg:pb-16">
